...
public class GLCube {
    ...
    public GLCube(Context context){
        ...
        int vertexShaderHandle = MyGLRenderer.loadShader(
                ...
                RawResourceReader.readTextFileFromRawResource(context, R.raw.cube_vertex_shader));
        int fragmentShaderHandle = MyGLRenderer.loadShader(
                GLES20.GL_FRAGMENT_SHADER,
                RawResourceReader.readTextFileFromRawResource(context, R.raw.cube_fragment_shader));
        ...
        // load texture
        mTextureHandle = MyGLRenderer.loadTexture(mActivityContext, R.drawable.box_texture);
    }
    public void draw(float[] mViewMatrix, float[] mProjectionMatrix, float[] mRotateMatrix){
  ...
  //      Matrix.rotateM(mModelMatrix, 0, angleInDegrees, 1.0f, 1.0f, 0.0f);
        ...
        Matrix.multiplyMM(mMVPMatrix, 0, mViewMatrix, 0, scratch, 0);
